...
void    Claptrap::attack(const std::string& target)
{
    ...
    {
        this->_pEnergy -= 1;
        std::cout << this->_name << " : attack enemy " << target << " causing "<< this->_pHit << " points of damage !" << std::endl;
    }
}
...
{
    std::cout << "HP:" << this->_pHit << "/100" << std::endl;
    std::cout << "Energy:" << this->_pEnergy << "/50" << std::endl;
}
